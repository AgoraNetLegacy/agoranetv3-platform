...
export const HELP_CORPUS_VERSION = "1.1.0+6b3e3812fc78ae7a" as const;
...
export const GENERATED_HELP_RETRIEVAL_DOCUMENTS = [
  ...
  },
  {
    ...
    "title": "Onboarding was interrupted",
    "summary": "Return to the journey without sharing or recreating secrets unnecessarily.",
    "text": "Open [AgoraNet onboarding](/verify) in the same browser you used before. AgoraNet will carry forward any completed server-side stage. You do not need to know the internal name of the onboarding screen, and Support will never ask you to reconstruct or share a secret that was shown once.\n\nIf you already created an identity and saved its access key, open [Sign in](/login) instead of beginning again. If a one-time access key was shown but not saved, do not create another identity or send any secret to Support. Read [Your two codes; what to save, and what loss means](/support/what-to-save) before taking another action.",
    "audience": "public",
    "categoryId": "getting-started",
    "documentType": "troubleshooting",
    "risk": "normal",
  ...
  },
  {
    ...
    "title": "Verification is pending, rejected, or interrupted",
    "summary": "Resume safely, understand the current test-rail limits, and know when a human must review the issue.",
    "text": "Open [AgoraNet onboarding](/verify) again in the same browser. A page refresh or closed tab does not create a second identity; incomplete ceremonies simply return to the last safe boundary.\n\nIf the onboarding page reports an error, copy the non-secret error code and the stage where it happened. Never send your Humanity Credential, access key, wallet seed phrase, or private key to Support.\n\nA verification decision that requires review cannot be changed by the helpdesk. Open a support case so a human can inspect the safe diagnostic record.",
    "audience": "public",
    "categoryId": "troubleshooting",
    "documentType": "troubleshooting",
    "risk": "high",
