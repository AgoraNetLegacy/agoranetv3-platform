...
export const HELP_CORPUS_VERSION = "1.4.0+1ad063cda1c48ab8" as const;
...
export const GENERATED_HELP_RETRIEVAL_DOCUMENTS = [
  {
    ...
    "title": "Donations and the treasury",
    "summary": "Check published treasury activity and distinguish AgoraNet Credits from test-network wallet assets and transactions.",
    "text": "Open Transparency for published fees and system activity. Open Treasury for public treasury balances and transactions. AgoraNet labels Credits separately from fake dPOLL and dGRA held in a Cardano testnet wallet. A pending Credit claim is also shown separately until the chain confirms delivery.\n\nIf a donation or treasury transaction looks missing, first check whether your wallet shows it as pending, failed, or confirmed. Save the transaction hash, which is the public reference shown by the wallet, and note the approximate time.\n\nDo not retry a value-moving action repeatedly, and never send Support a wallet seed phrase, spending password, private key, or signing key. A confirmed transaction that is missing from AgoraNet, an unexpected balance change, or suspected theft requires a human support request.",
    "audience": "public",
    "categoryId": "economy",
    "documentType": "concept",
    "risk": "normal",
  ...
  },
  {
    ...
    "title": "Credits, wallet balances, PollCoin, and Gratium",
    "summary": "Start with simple AgoraNet Credits, or connect a testnet wallet when you are ready to use fake dPOLL and dGRA directly.",
    "text": "You do not need a crypto wallet to use AgoraNet. New profiles begin in Credits mode. PollCoin Credits, shown as PC Credits, pay ordinary participation fees and deposits. Gratium Credits, shown as G Credits, record appreciation. They are internal AgoraNet units, not coins already held in a wallet.\n\nIf you already understand wallets, open Settings, connect a supported Cardano testnet wallet, and choose Wallet mode. Wallet mode displays fake dPOLL and dGRA held by that wallet. These test assets have no real value. Your wallet remains under your control; AgoraNet never asks for its seed phrase or private key.\n\nWallet mode is not just a different balance display. For an action marked wallet-ready, Lace opens and shows the fake-token payment for you to approve. AgoraNet publishes the action only after the test network confirms the expected payment from the wallet linked to that identity. Supported rewards are queued to that same wallet. If an action is not wallet-ready, AgoraNet tells you to switch that identity to Credits mode; it does not quietly take internal Credits.\n\nThe first wallet-ready action is an ordinary Discussion post or reply. Lace asks for the displayed dPOLL fee. After you approve it, the page may say **pending** while Cardano Preprod confirms the payment. Do not pay a second time. If the browser closes, AgoraNet keeps the public transaction hash and can finish the pending post automatically.\n\nWhen testnet Credit claims are enabled, a Credits user may explicitly claim eligible Credits as fake wallet assets. This is never automatic: AgoraNet shows the amount, destination, pending state, and confirmation separately. Credits and wallet balances are never silently combined.\n\nSmall fees and refundable deposits discourage automated spam and repeated disruptive actions. A fee is not vote weight, reputation, or permission to break a rule. Current amounts and limits are published on Transparency and may change through the platform's approved voting process.\n\nAgoraNet does not sell or rank attention. Views, time spent reading, and engagement tracking are not used to build a personal advertising profile or to decide what appears in search.",
    "audience": "public",
    "categoryId": "economy",
    "documentType": "concept",
    "risk": "normal",
  ...
  },
  {
    ...
    "title": "Post or reply with your testnet wallet",
    "summary": "In Wallet mode, Lace asks you to approve the displayed fake dPOLL fee before AgoraNet publishes a Discussion post.",
    "text": "You can use AgoraNet without a wallet. This page applies only after you deliberately choose **Wallet mode** in Settings.\n\nTo make an ordinary Discussion post or reply in Wallet mode:\n\n1. Write the post and select the posting button. 2. AgoraNet checks the post before asking for payment. 3. Lace opens and shows the fake **dPOLL** fee. Cardano also requires test tADA for the network fee and the script output, so the wallet needs both fake dPOLL and enough test tADA. Check that Lace is on the test network named in Settings and is using the account linked to this AgoraNet identity. 4. Approve the transaction in Lace. AgoraNet never sees your spending password, seed phrase, or private key. 5. Wait while the page says **pending**. AgoraNet publishes the post only after the test network proves that the linked wallet sent the correct fake asset and amount to the expected script.\n\nPending does not mean failure. Cardano confirmation can take a little time. Do not pay again. If you close the page or the app restarts after the transaction was submitted, AgoraNet keeps the public transaction hash and can finish the post automatically.\n\nWhen the post is confirmed, eligible fake dGRA and dPOLL rewards are queued to the linked wallet. Reward delivery may appear after the post because it is processed separately and verified on the chain.\n\nSome AgoraNet actions are not wallet-ready yet, including workshop posts that require two token types, tips, permanence upgrades, and mission releases. AgoraNet will tell you when that happens. Switch this identity to Credits mode in Settings if you need one of those actions now. The platform will not silently use internal Credits while the identity remains in Wallet mode.\n\nIf Lace shows the wrong account, decline the request, switch accounts in Lace, and try again. If the transaction was already submitted and the post still does not appear, open Help and Support and include the public transaction hash and the exact non-secret message shown. Never include an access key, seed phrase, spending password, signing key, or private key.",
    "audience": "public",
    "categoryId": "economy",
    "documentType": "procedure",
    "risk": "normal",
  ...
  },
  {
    ...
    "title": "Wallet connection troubleshooting",
    "summary": "Unlock Lace, select the test network shown by AgoraNet, reload once, and approve the browser connection.",
    "text": "You can keep using Credits mode without a wallet. Connect one only if you want to test wallet-owned fake assets.\n\nAgoraNet's current wallet features use a Cardano test network, not Cardano mainnet. Confirm that the Lace browser wallet is installed and unlocked. In Lace, select the same test network named on the AgoraNet Settings page.\n\nReturn to Settings, reload the page once, select Connect Lace, and approve the request in the Lace window. After it connects, choose Wallet mode if you want to use the wallet directly, or keep Credits mode. If no wallet window appears, check whether the browser blocked a pop-up or whether the Lace window opened behind another window.\n\nIf AgoraNet says Lace opened the wrong account, open Lace and select the same account you linked to the current AgoraNet identity. Your True Self and Alias should use separate Cardano accounts. Then return to the page and try again.\n\nIf a post says its payment was submitted or pending, **do not click again and do not make a second payment**. Leave the page open if convenient, but it is safe to close it: AgoraNet stores the public transaction hash and its recovery process can finish the post after the test network confirms. A message that says the payment needs support review means the fake payment was preserved even though the post could not be published automatically.\n\nIf it still does not connect, open Help and Support and include the browser name, selected network, and non-secret error message. A public wallet address or transaction hash may be included when needed. Never include a seed phrase, spending password, signing key, private key, or access key.",
    "audience": "public",
    "categoryId": "troubleshooting",
    "documentType": "troubleshooting",
    "risk": "normal",
